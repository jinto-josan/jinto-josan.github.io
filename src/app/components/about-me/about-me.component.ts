...
export class AboutMeComponent {
  aboutMe = {
    ...
    bio: 'Full stack developer wFull Stack Developer with expertise in .NET, Java, Angular, Azure, DevOps, and design patterns, specializing in building scalable web applications and optimizing CI/CD pipelines for high-performance, cloud-based solutions.',
